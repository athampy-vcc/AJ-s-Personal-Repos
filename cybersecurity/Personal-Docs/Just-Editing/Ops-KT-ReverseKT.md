...
• Day 1 Operations: All accounts must be onboard and integrated with the tools 
		    o Sentinel (logging and monitoring)
		    o  Qualys (vulnerability management)
		    o  CNAPP tools (Defender for Cloud or Prisma)
• Day 2 operations: Team is responsible for Implement automated remediation wherever possible
      o	Improve Cloud Security Score (>90%)
      o	Implement automated remediation wherever possible
      o	Reduce dependency on application teams
	  o   Build a standardized governance model
...
Medium Severity Findings
     ...
     3.	Allow ~1 week window
     4.	If unresolved → Ops team auto-remediates
...
Vulnerability Handling:
    ...
    •	Operation team need to focus on vulnerabilities that are linked to our own App ID’s
...
In such cases:
Exception request must be raised
Must be approved by:Premkumar / Gusten,Cybersecurity team

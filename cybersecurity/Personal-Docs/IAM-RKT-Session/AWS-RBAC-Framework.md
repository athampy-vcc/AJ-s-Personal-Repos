...
When an IAM user is unavoidable, a **permission boundary** is attached so the user cannot escalate beyond the intended scope. Typical denials in the boundary:
